...
const faqItems = [
  ...
  {
    question: "آیا همنشینیهای راوی آنلاین هم برگزار می‌شوند؟",
    answer:
      "بله، علاوه بر همنشینیهای حضوری، جلسات آنلاین گروهی نیز داریم تا بتوانید در هر شرایطی با افراد جدید آشنا شوید.",
  },
  {
